...
<img width="654" height="279" alt="image" src="https://github.com/user-attachments/assets/22de9d1a-b518-4183-87dd-3121c0133c14" />
...
cd rknn-toolkit2
# 安装RKNN-Toolkit2依赖
pip install -r requirements_cp310_linux.txt  # 对应Python3.10，其他版本替换后缀
